...
{
    public class MeanShiftClustering_StepByStep_Test
    {
        [Fact]
        public void Cluster_EmptyInput_ReturnsEmptyClusters()
        {
            ...
            // Act
            var result = new MeanShiftClustering().Cluster(emptyData, bandwidth);
        ...
        public void Cluster_BandwidthAndDatasetDimensionDoesNotMatch_ShouldThrowError()
        {
            ...
            // Act
            Action act = () => new MeanShiftClustering().Cluster(data, bandwidth);
        ...
        public void Cluster_ReturnsCorrectClusters()
        {
            ...
            var result = new MeanShiftClustering().Cluster(data, bandwidth);
        ...
        public void Cluster_LargeBandwidth_ReturnsSingleCluster()
        {
            ...
            // Act
            var result = new MeanShiftClustering().Cluster(data, largeBandwidth);
        ...
        public void Cluster_WithDataSpreadAround_WithSmallBandwidth_ShouldReturnIndividualClusters()
        {
            ...
            // Act
            var result = new MeanShiftClustering().Cluster(data, smallBandwidth);
