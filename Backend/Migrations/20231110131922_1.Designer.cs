            ...
            modelBuilder.Entity("WebApplication1.Data.DataModels.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Id = new Guid("3947cd55-f7c5-4968-a33c-986300642816"),
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("386384d0-6d1f-456b-b866-89fca7d16fda"),
                            Name = "Espresso",
                            Price = 30f
                        },
                        new
                        {
                            Id = new Guid("eff1012e-e9df-42ab-b3c7-18e0f692ef1d"),
                            Name = "Smoothie",
                            Price = 50f
                        },
                        new
                        {
                            Id = new Guid("780ecbca-2005-4f24-8179-2051cf0a72b8"),
                            Name = "Bun with cheese",
                            Price = 60f
                        });
                });
